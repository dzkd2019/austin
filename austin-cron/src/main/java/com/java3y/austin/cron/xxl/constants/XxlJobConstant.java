...
public class XxlJobConstant {
     ...
     * 任务信息接口路径
     */
    public static final String LOGIN_URL = "/auth/doLogin";
    public static final String INSERT_URL = "/jobinfo/insert";
    ...
    public static final String JOB_GROUP_INSERT_URL = "/jobgroup/insert";
    /**
     * 执行任务名称
     */
